...
# resume_videos = ['y8YH0Qbu5h4','J-4Fv8nq1iA',
#                  'yp693O87GmM','UeMmCex9uTU',
#                  'dQ7Q8ZdnuN0','HQqqQx5BCFY',
#                  'CLUsplI4xMU','pbczsLkv7Cc']

# interview_videos = ['Ji46s5BHdr0','seVxXHi2YMs',
#                     '9FgfsLa_SmY','2HQmjLu-6RQ',
#                     'DQd_AlIvHUw','oVVdezJ0e7w'
#                     'JZK1MZwUyUU','CyXLhHQS3KY']